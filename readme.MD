...
***With the new Rust implementation [BAG of Rust (BOR)](https://codeberg.org/poorting/BAG_of_Rust) (doing the same thing, only 5 times faster) fully functional, this parser will no longer be actively maintained.***
